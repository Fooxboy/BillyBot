...
namespace Billy.Data.Commands
{
    public class Chat : IDataCommand
    {
        ...
        public static string TitleNotUnBlock = "Вы не можете разблокировать название текущей беседы. Это могут тот, кто сохранил название и создатель групповой беседы.";
