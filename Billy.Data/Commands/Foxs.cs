    ...
    public class Foxs : IDataCommand
    {
        ...
        public static string Buy(string url, long UserId)
        {
            string text = $"ПОКУПКА ФОКСОВ:" +
                ...
                $"\nP.S. Если Вы оплачиваете с другово сервиса, тогда Вы платите коммиссию перевода." +
                $"\nПосле оплаты Вы можете проверить Ваш платёж. Напишите: Билли, фоксы проверить.";
            return text;
        }
